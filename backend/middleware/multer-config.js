...
const storage = multer.diskStorage({
    destination: (req, file, callback) => {
        // it gives you the details of your image, fieldname, originalname, mimitype
        console.log(file);
...
// here 'file' is fieldname and you will use it in the frontend. So be carefull to use the correct name in frontend.
